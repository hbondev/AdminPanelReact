      ...
      <main className="flex-1 order-2">
        ...
        <section className="p-4 md:p-6 max-w-[100vw]">
          <Routes>
            ...
            {/* مسیرهای فرعی باید قبل از مسیر اصلی بیان */}
            <Route path="/blog/add" element={<Details type="posts" />} />
            <Route path="/blog/:id" element={<Details type="posts" />} />

            {/* از `end` استفاده کن تا فقط دقیقاً `/blog` مچ بشه */}
            <Route path="/blog" element={<Blog />} />

            {/* مسیرهای دیگر */}
            <Route
              path="/users/add"
              element={<Details type="users" title="افزودن کاربر" />}
            />
            <Route
              path="/users/:id"
              element={<Details type="users" title="ویرایش کاربر" />}
            />
          </Routes>
        </section>
      </main>
